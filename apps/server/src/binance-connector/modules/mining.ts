 ...
 * @param {*} superclass
 */
export const Mining = (superclass) =>
  class extends superclass {
    ...
    miningAlgoList(options = {}) {
      return this.publicRequest('GET', '/sapi/v1/mining/pub/algoList', options);
    }
    ...
    miningCoinList(options = {}) {
      return this.publicRequest('GET', '/sapi/v1/mining/pub/coinList', options);
    }
