 ...
 * @param {*} superclass
 */
export const Futures = (superclass) =>
  class extends superclass {
    ...
    futuresLoanWallet(options = {}) {
      return this.signRequest('GET', '/sapi/v2/futures/loan/wallet', options);
    }
    ...
    futuresLoanConfigs(options = {}) {
      return this.signRequest('GET', '/sapi/v2/futures/loan/configs', options);
    }
